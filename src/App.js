  ...
  return (
    <div class="navbar"> 
      ...
      <ul class="navbar-right">
        ...
        <li class="nav-item">
          <a href="#" class="navbar-button">Sign In</a>
        </li>
      </ul>
    </div>  
  );
...
function Footer() {
  return (
    <div class="footer">
      <ul class="footer-upper fixed-bottom">
        <li class="nav-item">
          <a href="#" class="footer-button mr-10">Terms of Use</a>
        </li>
        <li class="nav-item">
          <a href="#" class="footer-button">Privacy and Policy</a>
        </li>
        <li class="nav-item">
          <a href="#" class="footer-button ml-10">Contact Us</a>
        </li>
      </ul>
      <ul class="footer-lower fixed-bottom mb-4">
        <li class="nav-item">
